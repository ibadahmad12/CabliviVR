...
const data = [
  ...
  ["HEMATOCRIT", "27", "%", "36 to 47"],
  ["HAPTOGLOBIN", "6.0", "mg/dL", "30 to 200"],
  ["PLATELET COUNT", "12.0 * 10 ^ 9", "L", "150 to 400 * 10 ^ 9"],
  ["WHITE BLOOD CELL COUNT", "10 * 10 ^ 9", "L", "4 to 10 * 10 ^ 9"],
  ["RED BLOOD CELL COUNT", "4.29 * 10 ^ 12", "L", "4.2 TO 5.4 * 10 ^ 12"],
  ["RETICULOCYTES", "3.0", "H", "0.5 TO 1.5"],
  ["MCV", "<90", "fL", "80 to 100"],
  ["SERUM CREATININE", "1.51", "mg/dL", "0.59 to 1.04"],
  ["LDH", "722", "U/L", "50 to 150"],
  ["TROPONIN", "0.6", "ng/mL", "0 to 0.4"],
